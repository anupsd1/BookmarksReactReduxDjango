...
site_full_name = "footbuys"
site_shortcut_name = "footbuys"
...
class CustomPasswordTokenVerificationView(APIView):
    """
        An Api View which provides a method to verify that a given pw-reset token is valid
        before actually confirming the reset.
    """
    throttle_classes = ()
    permission_classes = ()
